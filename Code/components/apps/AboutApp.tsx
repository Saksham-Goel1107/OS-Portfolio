            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col gap-3.5">
                    <p className="text-[13px] leading-[1.7]" style={{ color: '#bbb' }}>
                        I am Saksham Goel, a Second Year Computer Engineering student who enjoys exploring how software and systems work at a deeper level. My interests lie in low level programming, system design, and understanding the logic that powers modern computing. I like breaking complex problems into smaller parts and building solutions step by step.
                    </p>
                    <p className="text-[13px] leading-[1.7]" style={{ color: '#bbb' }}>
