                    ...
                    <section id="sp-about" style={{ padding: '80px 0 52px' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 18, alignItems: 'center' }}>
                            {[
                                ...
                                { icon: Svg.github, text: 'Saksham-Goel1107', href: `https://${PORTFOLIO.github}` },
                                { icon: Svg.linkedin, text: 'in/sakshamgoel11', href: `https://${PORTFOLIO.linkedin}` },
                                { icon: Svg.twitter, text: '@Saksham1199805', href: `https://${PORTFOLIO.twitter}` },
                    ...
                    <section id="sp-contact" style={{ padding: '56px 0 20px' }}>
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                            ...
                            <div>
                                ...
                                <textarea placeholder="Hey Saksham, I would love to chat about..." value={form.message} required rows={5}
